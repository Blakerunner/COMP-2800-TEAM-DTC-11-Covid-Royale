...
export class LoadScene extends Phaser.Scene {
    ...
    preload(){
        ...
        this.load.image("handsanitizer", "./assets/img/handsanitizer.png");
        this.load.image("facemasks", "./assets/img/facemasks.png");
        this.load.image("hazmat suit", "./assets/img/hazmatSuit.png");
