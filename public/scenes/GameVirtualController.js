...
export class GameVirtualController extends Phaser.Scene {
    ...
    create(){
        ...
        let buttonYPosX = 592
        let buttonYPosY = 288
        let buttonLeftPosX = 48
        let buttonLeftPosY = 272
        let buttonRightPosX = 144
        let buttonRightPosY = 272
        let buttonUpPosX = 96
        let buttonUpPosY = 224
        let buttonDownPosX = 96
        let buttonDownPosY = 320
        ...
        // left button
        let buttonLeft = this.add.sprite(buttonLeftPosX, buttonLeftPosY, 'buttonHorizontal', 1).setScale(1).setScrollFactor(0).setInteractive();
        ...
        // right button
        let buttonRight = this.add.sprite(buttonRightPosX, buttonRightPosY, 'buttonHorizontal', 1).setScale(1).setScrollFactor(0).setInteractive();
        ...
        // up button
        let buttonUp = this.add.sprite(buttonUpPosX, buttonUpPosY, 'buttonVertical', 1).setScale(1).setScrollFactor(0).setInteractive();
        ...
        // down button
        let buttonDown = this.add.sprite(buttonDownPosX, buttonDownPosY, 'buttonVertical', 1).setScale(1).setScrollFactor(0).setInteractive();
